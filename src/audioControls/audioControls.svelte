...
/>
<!-- styling: primary-color, secondary-color, background-color, text-color -->
<style>
    .controls {
        display: flex;
        flex-flow: row;
    ...
    .tooltip {
        ...
        border-radius: 5px;
        border-width: 3px;
        box-shadow: 6px 6px var(--secondary-color, lightgray);
        color: var(--secondary-text-color, gray);
        pointer-events: none;
        min-width: 50px;
        text-align: center;
    ...
    .material-icons:hover {
        box-shadow: 0px 6px var(--secondary-text-color, gray);
    }
